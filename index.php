...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content="leaderboard that fetches data from a JSON or CSV file..">
...
<body>
	 <nav class="navbar navbar-light" style="background-color: #00aeff">
        <a class="navbar-brand" href="#" id="text">
         ...
         <span style="color: white;"> HNG Internship </span><a style="background-color: red; color: white;" href="admin.php">Add score</a> 
        </a>
      </nav>
<!--
...
<div class="leaderboard">
  ...
  <ol>
    ...
    <li>
      <mark><?php echo $username[$d] ?></mark>
      <small><?php echo $point[$d] ?></small>
